...
class TestTagRegistry:
    ...
    def test_tag_registry_initialization(self, temp_dir):
        ...
        media_registry_path = os.path.join(temp_dir, "media_registry.json")
    ...
    def test_tag_registry_save_and_load(self, temp_dir):
        ...
        test_data = {
            ...
            'media_tags': {'media/test.jpg': ['test_tag']},
    ...
    def test_add_and_get_media_tags(self, temp_dir):
        ...
        # Add tags to media
        tags = ['tag1', 'tag2', 'tag3']
        success = tag_registry.add_media_tags('media/test.jpg', tags)
        assert success is True
        
        # Get tags for specific media
        media_tags = tag_registry.get_media_tags_for_file('media/test.jpg')
        assert media_tags == tags
        
        # Get all media tags
        all_media_tags = tag_registry.get_media_tags()
        assert 'media/test.jpg' in all_media_tags
        assert all_media_tags['media/test.jpg'] == tags
    ...
    def test_remove_media_tags(self, temp_dir):
        ...
        # Add tags first
        tags = ['tag1', 'tag2']
        tag_registry.add_media_tags('media/test.jpg', tags)
        
        # Remove tags
        success = tag_registry.remove_media_tags('media/test.jpg')
        assert success is True
    ...
    def test_get_media_tags_for_nonexistent_file(self, temp_dir):
        ...
        tags = tag_registry.get_media_tags_for_file('media/nonexistent.jpg')
        assert tags == []
    ...
    def test_remove_nonexistent_media_tags(self, temp_dir):
        ...
        success = tag_registry.remove_media_tags('media/nonexistent.jpg')
        assert success is False
